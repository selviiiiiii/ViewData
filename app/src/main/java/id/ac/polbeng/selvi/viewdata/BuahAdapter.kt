package id.ac.polbeng.selvi.viewdata
...
import id.ac.polbeng.selvi.viewdata.DetailBuahActivity
import id.ac.polbeng.selvi.viewdata.databinding.ListItemBinding
class BuahAdapter(
